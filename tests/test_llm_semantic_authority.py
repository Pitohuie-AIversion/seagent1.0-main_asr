...
def test_change_start_time_with_end_time_unchanged_preserves_previous_end() -> None:
    ...
    try:
        ...
        assert candidates["start_time"]["normalized_value"] == "2026-08-27T07:00:00"
        assert candidates["end_time"]["normalized_value"] == "2026-08-27T12:00:00"
        assert candidates["end_time"]["resolution_method"] == "end_time_unchanged"
    finally:
        get_simulated_time().reset()
