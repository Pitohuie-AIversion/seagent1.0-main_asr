...
def get_current_datetime() -> datetime:
    """获取当前仿真时间，优先兼容外部针对 src.validator.get_current_datetime 的动态 Mock"""
    import sys
    val_mod = sys.modules.get("src.validator")
    if val_mod is not None:
        ...
        if gcd is not None and callable(gcd):
            try:
                ...
                pass
    from .simulated_time import get_current_datetime as _gcd
    return _gcd()
