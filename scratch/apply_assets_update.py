...
# Save back to assets.yaml with UTF-8 encoding and pretty formatting
class IndentedDumper(yaml.Dumper):
    def increase_indent(self, flow=False, indentless=False):
        return super(IndentedDumper, self).increase_indent(flow=False, indentless=False)

with open(assets_path, 'w', encoding='utf-8') as f:
    yaml.dump(assets, f, Dumper=IndentedDumper, allow_unicode=True, sort_keys=False, default_flow_style=False)

print("assets.yaml successfully updated!")
