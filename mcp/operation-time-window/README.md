...
├── README.md                              # 模块快速入门与架构说明
├── DESIGN_SPEC.md                         # 核心技术方案与独立骨架规范说明书
├── evidence/                              # 验证与测试证据归档
│   ├── baseline_status.json               # 初始基线验证状态证据 (41 passed, MCP blocked)
│   ├── current_status.json                # 当前验证状态证据 (50+ passed, MCP 协议全通)
│   ├── unit-results.xml                   # 单元测试 JUnit XML 证据报告
│   └── mcp-results.xml                    # FastMCP stdio 协议测试 JUnit XML 证据报告
